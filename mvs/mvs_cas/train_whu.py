...
parser.add_argument('--model', default='adamvs', help='select model from [casmvsnet, msrednet, adamvs, ucsnet]')

# dataset and pretrained model path
parser.add_argument('--set_name', default='whu_omvs', help='give the dataset name')
parser.add_argument('--dataset', default='cas_rscv', help='select dataset')
parser.add_argument('--normalize', type=str, default='mean', help='methods of center_image, mean[mean var] or standard[0-1] or vit.') # attention: CasMVSNet [0-255];; CasREDNet [mean var]

parser.add_argument('--trainpath', default='/extra_data/liujin/MVS_traindata/meitan_oblique/train', help='train datapath')
parser.add_argument('--testpath', default='/extra_data/liujin/MVS_traindata/meitan_oblique/test', help='test datapath or validation datapath')
parser.add_argument('--loadckpt', default=None, help='load checkpoints')
parser.add_argument('--logdir', default='./checkpoints/adamvs_whuomvs_view7', help='the directory to save checkpoints/logs')
...
train_dataset = MVSDataset(args.trainpath, args.set_name, "train", args.view_num, args.interval_scale, args.normalize)
test_dataset = MVSDataset(args.testpath, args.set_name, "test", args.view_num, args.interval_scale, args.normalize)
